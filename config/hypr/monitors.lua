...
local omadora_gdk_scale = 2
local omadora_monitor_scale = "auto"
...
-- local omadora_gdk_scale = 1.75
-- local omadora_monitor_scale = 1.6

-- Straight 1x setup for low-resolution displays like 1080p, 1440p, or ultrawides: both 1.
-- local omadora_gdk_scale = 1
-- local omadora_monitor_scale = 1

hl.env("GDK_SCALE", tostring(omadora_gdk_scale))
hl.monitor({ output = "", mode = "preferred", position = "auto", scale = omadora_monitor_scale })
